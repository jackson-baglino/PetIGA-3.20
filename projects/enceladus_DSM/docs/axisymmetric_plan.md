...
> ✅ **CURRENT (banner 2026-07-22).** Applies to the two-phase model as implemented. Predates the renames to `sublimation_pf` (2026-07-21) and `enceladus_DSM` (2026-07-27) — read any `projects/permafrost` or `projects/sublimation_pf` path as `projects/enceladus_DSM`.
...
- **V3 — Molaro rerun (HPC):** molaro_2D_L385um_eps0.46um_axisym + molaro_T-20_h1.00_2h_a2e-3,
