...
Why: plot_fields_highres.py's dense (n_per_elem=4) VTS output is ~70MB
...
Then hand the resulting pf_highres.pvd to make_movie.py with the
...
def main():
    ...
    p.add_argument("--n-per-elem", type=int, default=4,
                   help="passed through to plot_fields_highres.py (default: 4)")
    ...
    pvd_path = args.pvd or os.path.join(args.dir, "pf.pvd")
