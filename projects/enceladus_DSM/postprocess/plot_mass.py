#!/usr/bin/env python3
"""
plot_mass.py  —  Plot phase mass vs. time for a phase-field simulation.
...
Physical constant (rho_ice) must match src/<project>_main.c.
...
# ---------------------------------------------------------------------------
# Physical constants — must match src/<project>_main.c
# ---------------------------------------------------------------------------
