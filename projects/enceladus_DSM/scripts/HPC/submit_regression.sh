...
# overriding the default #SBATCH directives in run_enceladus.sh so 1D jobs
...
REGRESSION_GEOMS=(
    "1D_ice_sed_pair"
    "iceslab_1D_L100um_eps0.71um"
    "1D_separated_grains"
    "singleice_1D_L62um_eps0.71um"
    "1D_touching_grains"
...
echo "✅ Build complete: $(ls -la ./enceladus_dsm | awk '{print $5, $6, $7, $8}')"
...
submit_one() {
    ...
    # the skip-compile flag — see compile_code() in run_enceladus.sh.
...
echo "============================================================"
echo "  Enceladus DSM regression sweep"
echo "  Tag        : $TAG"
