...
#
# Examples:
#   ./scripts/HPC/submit_enceladus.sh 2D_multi_grain_test 2day_T-20_h0.95
#
#   ./scripts/HPC/submit_enceladus.sh 2D_multi_grain_test 2day_T-20_h0.95 p2_run \
#       --time=0-12:00:00 --partition=expansion
#
#   ./scripts/HPC/submit_enceladus.sh 2D_single_bump_two_grains 21day_T-20_h0.95 \
