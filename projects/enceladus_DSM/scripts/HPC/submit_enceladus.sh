...
#
# Examples:
#   ./scripts/HPC/submit_enceladus.sh 2D_multi_grain_test base_T-20_h0.95_1d
#
#   ./scripts/HPC/submit_enceladus.sh 2D_multi_grain_test base_T-20_h0.95_1d p2_run \
#       --time=0-12:00:00 --partition=expansion
#
#   ./scripts/HPC/submit_enceladus.sh 2D_single_bump_two_grains base_T-20_h0.95_1d \
