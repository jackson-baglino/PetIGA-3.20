#!/usr/bin/env bash
# =============================================================================
# run_enceladus.sh — Build, run, and post-process a enceladus_dsm simulation
#
# Location: $PETIGA_DIR/projects/enceladus_DSM/scripts/Studio/run_enceladus.sh
#
# Usage:
#   ./scripts/Studio/run_enceladus.sh <geometry> <experiment> [tag]
#
...
# earlier settings) and passes the result to `enceladus_dsm`.
#
...
#   ./scripts/Studio/run_enceladus.sh <geometry> my_experiment [tag]
#
# -----------------------------------------------------------------------
...
# Script lives at: <project_root>/scripts/Studio/run_enceladus.sh
# ---------------------------------------------------------------------------
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# PROJECT_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"
PROJECT_ROOT="${PETIGA_DIR}/projects/enceladus_DSM"
...
usage() {
    echo ""
    echo "Usage:"
    echo "  ./scripts/Studio/run_enceladus.sh <geometry> <experiment> [tag]"
    echo ""
    echo "Arguments:"
...
# forwarded verbatim to the enceladus_dsm executable, AFTER the three
# -options_file flags — so they override anything in the opts files.
# Mirrors scripts/HPC/submit_enceladus.sh semantics, e.g.:
#   ./scripts/Studio/run_enceladus.sh GEOM EXP mytag -- -dtmax 1.0e2
...
echo ""
echo "========================================================================="
echo "  Enceladus DSM simulation workflow"
echo "  Project root : $PROJECT_ROOT"
