...
//   // Replace this with a call using PETSC options
...
//   ierr = PetscOptionsBool("-Permafrost_output","Enable output files",__FILE__,output,&output,NULL);CHKERRQ(ierr);
//   ierr = PetscOptionsBool("-Permafrost_monitor","Monitor the solution",__FILE__,monitor,&monitor,NULL);CHKERRQ(ierr);
...
//   } else {
//     ierr = FormInitialCondition3D(iga,t,U,&user,initial,PFgeom);CHKERRQ(ierr);
//   }
