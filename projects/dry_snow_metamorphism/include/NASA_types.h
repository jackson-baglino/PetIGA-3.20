...
typedef struct {
  ...
  PetscReal cent[3][2000];  // Coordinates of ice grain centers (3D array for x, y, z positions)
  PetscReal radius[2000];  // Radii of individual ice grains
  PetscReal centsed[3][2000];  // Coordinates of sediment grain centers (3D array for x, y, z positions)
  PetscReal radiussed[2000];  // Radii of individual sediment grains
