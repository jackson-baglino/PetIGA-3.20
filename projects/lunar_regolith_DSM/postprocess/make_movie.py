...
is autodetected (venv_lunar / venv_DSM); override with --gen-python.
...
def find_gen_python(explicit):
    ...
    for cand in (os.path.join(root, "venv_lunar", "bin", "python3"),
...
def main():
    ...
    p.add_argument("--gen-python", default=None,
                   help="Python interpreter (with igakit) used to generate each "
                        ...
                        "venv_lunar / venv_DSM. Ignored with --no-stream.")
