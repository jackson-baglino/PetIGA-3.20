...
Downstream parsers (`plot_timestep.py`, `plot_fields.py`,
...
Iterated several times to: (a) call `plot_fields.py` directly instead
...
**Why.** `plot_fields.py` had been clipping `AirPhase = 1 − ice − sed`
