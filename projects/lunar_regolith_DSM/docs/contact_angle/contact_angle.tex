...
Following Moure \& Fu, the interface energies are $\sia$, $\sis$ and $\sas$
...
$\Sigma_k=\sigma_{ka}+\sigma_{kb}-\sigma_{ab}$, i.e.
...
\code{-sigma\_ia} & ice--air interface energy; default \code{-sigma\_ia\_bulk} \\
\bottomrule
...
$\sia$ defaults to \code{-sigma\_ia\_bulk}: the wall sees the same ice--air
