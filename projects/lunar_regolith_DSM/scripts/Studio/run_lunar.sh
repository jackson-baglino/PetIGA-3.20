...
#   ./scripts/Studio/run_lunar.sh 1D_ice_slab base_T-20_h0.95_1d sweep_a
#   ./scripts/Studio/run_lunar.sh 2D_multi_grain_test base_T-20_h0.95_1d multigrain_2day
#
# -----------------------------------------------------------------------
...
usage() {
    ...
    echo "  ./scripts/Studio/run_lunar.sh 1D_ice_slab base_T-20_h0.95_1d sweep_a"
    echo ""
}
