...
echo " WARNING: This script is deprecated and will be removed in the future. Please use the new run_NASAv2.sh script instead."
echo "          The new script is located at: projects/dry_snow_metamorphism/scripts/studio/run_NASAv2.sh for local runs or projects/dry_snow_metamorphism/scripts/HPC/run_dsm.sh for HPC runs."
