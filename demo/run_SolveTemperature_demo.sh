...
create_folder() {
    ...
    dir="/Users/jacksonbaglino/SimulationResults/DrySed_Metamorphism/NASAv2_SolveTemp"
    folder="$dir/$name"
...
run_simulation() {
    ...
    mpiexec -np 12 ./SolveTemperature_demo -initial_PFgeom -temp_initial -snes_rtol 1e-3 \
